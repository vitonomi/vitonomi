...
- Never import from `clients/web/` or `cli/` — core has zero app-layer dependencies.
...
- Types and data format definitions are canonical here — clients/web/ and cli/ import them.
